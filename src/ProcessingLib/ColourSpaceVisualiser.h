...
namespace PreProcessor
{
    ...
    public: 
            ...
            : imageOfLego(*loadedImage)
        {
            ...
            cv::Mat hsv;
            cv::cvtColor(imageOfLego, hsv, cv::COLOR_BGR2HSV);
            ...
            cv::Mat lab;
            cv::cvtColor(imageOfLego, lab, cv::COLOR_RGB2Lab);
            ...
            cv::Mat luv;
            cv::cvtColor(imageOfLego, luv, cv::COLOR_RGB2Luv);
            ...
            cv::cvtColor(imageOfLego, image_greyscale, cv::COLOR_BGR2GRAY);
    ...
    private:
        ...
        const std::array<cv::Mat*, 14> channelAdresses = {&imageOfLego, &image_R, &image_G, &image_B, &image_hue, &image_saturation, &image_value, &image_Lumosity, &image_Axis, &image_BlueYellow, &image_Lumosity2, &image_U, &image_V}; 
    };
}
